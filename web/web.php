					...
					<div class="col-md-4 col-sm-4">
						...
						<div class="blog-photo-stream margin-bottom-30">
							<ul class="list-unstyled">
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image01.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image02.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image03.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image04.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image05.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image06.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image07.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image08.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image09.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/image10.jpg"></a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="main-container">
			...
			<div id="style_selector" class="hidden-xs">
				<div id="style_selector_container">
					...
					<div class="images icons-color">
						<a id="blue" href="#"><img class="active" alt="" src="<?php echo PASTASITE; ?>images/blue.png"></a>
						<a id="purple" href="#"><img alt="" src="<?php echo PASTASITE; ?>images/purple.png"></a>
						<a id="red" href="#"><img alt="" src="<?php echo PASTASITE; ?>images/red.png"></a>
						<a id="orange" href="#"><img alt="" src="<?php echo PASTASITE; ?>images/orange.png"></a>
						<a id="green" href="#"><img alt="" src="<?php echo PASTASITE; ?>images/green.png"></a>
					</div>
				...
				<div class="fullwidthabnner">
					<ul>
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							<img src="<?php echo PASTASITE; ?>images/sliders/slidebg3.png"  style="background-color:rgb(246, 246, 246)" alt="slidebg1"  data-bgfit="cover" data-bgposition="left bottom" data-bgrepeat="no-repeat">
							<div class="caption lft slide_title slide_item_left"
							data-x="0"
							data-y="105"
							data-speed="400"
						...
						<div class="col-sm-4">
							<div class="core-box">
								<div class="heading">
									...
									<h2>Para seu amiguinho</h2>
								</div>
								<div class="content">
									Já pensou em ter um plano de saúde para o seu animalzinho de estimação?
								</div>
							...
							<div class="grid-container animate-group" data-animation-interval="100">
									...
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="<?php echo PASTASITE; ?>images/image01.jpg" class="img-responsive"/>
								...
								<div class="col-md-3 col-sm-6">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="<?php echo PASTASITE; ?>images/image02.jpg" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												3 Columns Portfolio
								...
								<div class="col-md-3 col-sm-6">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="<?php echo PASTASITE; ?>images/image03.jpg" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												2 Columns Portfolio
								...
								<div class="col-md-3 col-sm-6">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="<?php echo PASTASITE; ?>images/image04.jpg" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												Single Project
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="flexslider" data-plugin-options='{"controlNav":false,"sync": "#carousel"}'>
								<ul class="slides">
									<li>
										<a class="group1" href="<?php echo PASTASITE; ?>images/image01.jpg" title="Caption here">
											<img src="<?php echo PASTASITE; ?>images/image01.jpg" />
											<span class="image-overlay"> <i class="clip-expand circle-icon circle-main-color"></i> </span>
										</a>
									</li>
									<li>
										<a class="group1" href="<?php echo PASTASITE; ?>images/image02.jpg" title="Caption here">
											<img src="<?php echo PASTASITE; ?>images/image02.jpg" />
											<span class="image-overlay"> <i class="clip-expand circle-icon circle-main-color"></i> </span>
										</a>
									</li>
									<li>
										<a class="group1" href="<?php echo PASTASITE; ?>images/image03.jpg" title="Caption here">
											<img src="<?php echo PASTASITE; ?>images/image03.jpg" />
											<span class="image-overlay"> <i class="clip-expand circle-icon circle-main-color"></i> </span>
										</a>
									</li>
									<li>
										<a class="group1" href="<?php echo PASTASITE; ?>images/image04.jpg" title="Caption here">
											<img src="<?php echo PASTASITE; ?>images/image04.jpg" />
											<span class="image-overlay"> <i class="clip-expand circle-icon circle-main-color"></i> </span>
										</a>
									</li>
									<li>
										<a class="group1" href="<?php echo PASTASITE; ?>images/image05.jpg" title="Caption here">
											<img src="<?php echo PASTASITE; ?>images/image05.jpg" />
											<span class="image-overlay"> <i class="clip-expand circle-icon circle-main-color"></i> </span>
										</a>
									</li>
								</ul>
							...
							<div id="carousel" class="flexslider animate-group" data-plugin-options='{"itemWidth": 120, "itemMargin": 5}'>
								<ul class="slides">
									<li>
										<img src="<?php echo PASTASITE; ?>images/image01.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
									<li>
										<img src="<?php echo PASTASITE; ?>images/image02.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
									<li>
										<img src="<?php echo PASTASITE; ?>images/image03.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
									<li>
										<img src="<?php echo PASTASITE; ?>images/image04.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
									<li>
										<img src="<?php echo PASTASITE; ?>images/image05.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
								</ul>
							</div>
						</div>
							...
							<ul class="slides">
								<li>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="<?php echo PASTASITE; ?>images/logo-1.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="<?php echo PASTASITE; ?>images/logo-2.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="<?php echo PASTASITE; ?>images/logo-3.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="<?php echo PASTASITE; ?>images/logo-4.png" alt="">
									</div>
								</li>
								<li>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive" src="<?php echo PASTASITE; ?>images/logo-4.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive" src="<?php echo PASTASITE; ?>images/logo-2.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="<?php echo PASTASITE; ?>images/logo-5.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="<?php echo PASTASITE; ?>images/logo-6.png" alt="">
									</div>
								</li>
							</ul>
						</div>
			...
			<section class="wrapper wrapper-grey">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<img src="<?php echo PASTASITE; ?>images/iphoneIpad-495x400.png" class="img-responsive animate-if-visible" data-animation-options='{"animation":"tada", "duration":"600"}'>
						</div>
						<div class="col-sm-6">
			...
			<section class="wrapper" style="min-height:400px; background-image: url('<?php echo PASTASITE; ?>images/photodune-4043508-3d-modern-office-room-l.jpg')" data-stellar-background-ratio="0.8" data-stellar-vertical-offset="-750">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
									...
									<ul class="slides">
											...
											<div class="col-md-12">
												...
												<div class="testimonial-author">
													<div class="img-thumbnail img-thumbnail-small">
														<img src="<?php echo PASTASITE; ?>images/avatar-1.jpg" alt="">
													</div>
													<p>
										...
										<li>
											<div class="col-md-12">
												...
												<div class="testimonial-author">
													<div class="img-thumbnail img-thumbnail-small">
														<img src="<?php echo PASTASITE; ?>images/avatar-2.jpg" alt="">
													</div>
													<p>
