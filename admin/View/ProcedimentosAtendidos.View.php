					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Procedimentos atendidos<small> Realizar Cadastro e Edição</small></h1>
							</div>
                                                        <p>Credenciado: </br>
					...
					<!-- start: PAGE CONTENT -->
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="panel-body">
                                            <form action="<?php echo HOME; ?>admin/Credenciado/ListarCredenciado" role="form" id="vincula-procedimentos-credenciado" name="vincula-procedimentos-credenciado" method="post"  enctype="multipart/form-data" class="formulario"> 
                                                ...
                                                ?>
                                                                ...
                                                                <?php echo $proc["nome"]; ?></label>
                                                                    ...
                                                                    <div class="form-group-<?php echo $proc["id_procedimento"]; ?> valor-apagar grupo-<?php echo $cat["id_categoria"]; ?>">
                                                                                ...
                                                                                <div class="col-sm-2">
                                                                                    <input id="valor-<?php echo $proc["id_procedimento"]; ?>" name="valor-<?php echo $proc["id_procedimento"]; ?>" class="form-control moeda valor-<?php echo $cat["id_categoria"]; ?>" type="text" value="<?php echo $preco; ?>"/>
                                                                                </div>
                                                                        </div></br></br>                                                      
                                                        <?php
                                                            endif;
                            ...
                            <button data-style="zoom-out" class="btn btn-success ladda-button" type="submit" value="vincula-procedimentos-credenciado" name="vincula-procedimentos-credenciado" style="margin-top: 10px;">
