							...
							<div id="style_selector" class="hidden-xs">
								<div id="style_selector_container" style="display:block">
									...
									<div class="images boxed-patterns">
										<a id="bg_style_1" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/bg.png"></a>
										<a id="bg_style_2" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/bg_2.png"></a>
										<a id="bg_style_3" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/bg_3.png"></a>
										<a id="bg_style_4" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/bg_4.png"></a>
										<a id="bg_style_5" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/bg_5.png"></a>
									</div>
									<div class="box-title">
										5 Predefined Color Schemes
									</div>
									<div class="images icons-color">
										<a id="light" href="#"><img class="active" alt="" src="<?php echo PASTAADMIN;?>images/lightgrey.png"></a>
										<a id="dark" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/darkgrey.png"></a>
										<a id="black_and_white" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/blackandwhite.png"></a>
										<a id="navy" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/navy.png"></a>
										<a id="green" href="#"><img alt="" src="<?php echo PASTAADMIN;?>images/green.png"></a>
									</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body panel-scroll" style="height:300px">
									<table class="table table-striped table-hover" id="sample-table-1">
										...
										<tbody>
											<tr>
												<td class="center"><img src="images/avatar-1.jpg" alt="image"/></td>
												<td>Peter Clark</td>
												<td class="hidden-xs">
											...
											<tr>
												<td class="center"><img src="images/avatar-2.jpg" alt="image"/></td>
												<td>Nicole Bell</td>
												<td class="hidden-xs">
												<a href="#" rel="nofollow" target="_blank">
													nicole@example.com
											...
											<tr>
												<td class="center"><img src="images/avatar-3.jpg" alt="image"/></td>
											...
											<tr>
												<td class="center"><img src="images/avatar-5.jpg" alt="image"/></td>
												<td>Kenneth Ross</td>
												<td class="hidden-xs">
												<a href="#" rel="nofollow" target="_blank">
													kenneth@example.com
											...
											<tr>
												<td class="center"><img src="images/avatar-4.jpg" alt="image"/></td>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body panel-scroll" style="height:460px">
											<ol class="discussion">
												<li class="other">
													<div class="avatar">
														<img alt="" src="images/avatar-4.jpg">
													</div>
													<div class="messages">
														<p>
															Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
